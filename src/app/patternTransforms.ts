...
function flipSelectionOnAxis(
  pattern: number[][],
  selection: Set<string>,
  axis: "h" | "v"
): { pattern: number[][]; flippedSelection: Set<string> } {
  if (selection.size === 0) return { pattern, flippedSelection: selection };
